...
Usernames: maya, lennie
There was /files/ftp on the web server  and we could upload files on ftp so did that and got a reverse shell 
Got `lennie: c4ntg3t3n0ughsp1c3` from the pcap file after some enumeration
...
drwx------ 6 lennie lennie 4096 Nov  9 01:30 ..
-rwxr-xr-x 1 root   root     77 Nov 12  2020 planner.sh
-rw-r--r-- 1 root   root      1 Nov  9 01:32 startup_list.txt
lennie@startup:~/scripts$ cat planner.sh
#!/bin/bash
echo $LIST > /home/lennie/scripts/startup_list.txt
/etc/print.sh
lennie@startup:~/scripts$ vi /etc/print.sh
